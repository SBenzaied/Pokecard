...
/*
//Type (id du type a recup)
$newType->setLibelle($dataType->id_pokemon);

//pokemon
$pokemon->setId($dataPokemon->id_pokemon);
$pokemon->setNom($dataPokemon->nom);
$pokemon->setType1($dataPokemon->id_type1);
if(isset($dataPokemon->id_type2)){
    $pokemon->setType2($dataPokemon->id_type2);
}
$pokemon->setImage($dataPokemon->id_image);
*/
